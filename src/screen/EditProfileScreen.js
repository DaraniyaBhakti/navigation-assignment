    ...
    return(
        ...
        <View style={styles.container}>
            ...
            <View style={styles.itemView}>
                ...
                <TextInput style={styles.textInput} placeholder='Contact no.' value='+91 9988337749' keyboardType='number-pad' />
            </View>
            <View style={styles.itemView}>
                <Icons name="email" size={20} color = {"#445773"} style={styles.icon}/>
                <TextInput style={styles.textInput} placeholder='Email address' value='xyz@yahoo.com'  keyboardType='email-address'/>
            </View>
            <View style={styles.itemView}>
                <Icon name="home" size={20} color = {"#445773"} style={styles.icon}/>
                <TextInput style={styles.textInput} placeholder='Address' value="XYZ Buillding, S.G.Highway" keyboardType='name-phone-pad' multiline={true} />
            </View>
            <View style={styles.itemView}>
